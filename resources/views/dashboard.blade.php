     ...
     <div class="max-w-7xl mx-auto py-8 px-4">
         <div class="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-8 mb-8">
             <div
                 ...
                 <div class="text-4xl font-extrabold mb-2">{{ Auth::user()->tasks()->count() }}</div>
             ...
             <div
                 ...
                 <div class="text-4xl font-extrabold mb-2">{{Auth::user()->tasks()->where('status','completed')->count()}}</div>
             ...
             <div
                 ...
                 <div class="text-4xl font-extrabold mb-2">{{Auth::user()->tasks()->where('status','pending')->count()}}</div>
